package com.gp.frame.basic.log;
 ...
 * </pre>
 * <p>
 * modify: zeng, 去掉注解，去掉getApp获取Context；
 * 使用前，需要调用init(Context);
 */
    ...
    public static class Config {
        ...
        public void init(Context pContext) {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && pContext.getExternalCacheDir() != null)
                sDefaultDir = pContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = pContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
        ...
        public Config setStackDeep(final int stackDeep) {
