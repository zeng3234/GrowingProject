...
public class SharedPreferenceUtils {
    ...
    public static final String NAME_PREFIX = "pj";
     ...
     *                   {@link Context.MODE_MULTI_PROCESS}, {@link Context.MODE_PRIVATE}
     */
    public static Editor getSharedPreferencesEditor(Context pContext, String pPrefsName, int pSPMode) {
    ...
    public static void setObject(Context pContext, String pKey, Object o) {
        Editor editor = getSharedPreferencesEditor(pContext);
